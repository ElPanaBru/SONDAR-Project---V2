...
const TRADUCCIONES = {
  en: {
    ...
    "Buscar usuarios, reels o eventos...": "Search users, reels or events...",
    "Evento": "Event",
    "Cuenta": "Account",
    ...
    "Reels, comentarios y publicaciones de comunidad.": "Reels, comments and community posts.",
    "Comentarios y respuestas": "Comments and replies",
    "Conversaciones nuevas en tus reels y publicaciones.": "New conversations on your reels and posts.",
    ...
    "Reels, eventos y publicaciones de comunidad nuevos.": "New reels, events and community posts.",
    ...
    "Solo vos y las cuentas que seguís pueden ver tus reels, eventos y listas.": "Only you and the accounts you follow can see your reels, events and lists.",
    ...
    "Crear nuevo reel": "Create new reel",
    "Géneros": "Genres",
    ...
    "Esta cuenta es privada": "This account is private",
    "Editar perfil": "Edit profile",
    "Aún no hay publicaciones.": "There are no posts yet.",
    "Aún no hay eventos.": "There are no events yet.",
    "Aún no hay favoritos.": "There are no favorites yet.",
  ...
  pt: {
    ...
    "Buscar usuarios, reels o eventos...": "Buscar usuários, reels ou eventos...",
    "Evento": "Evento",
    "Cuenta": "Conta",
    ...
    "Reels, comentarios y publicaciones de comunidad.": "Reels, comentários e publicações da comunidade.",
    "Comentarios y respuestas": "Comentários e respostas",
    "Conversaciones nuevas en tus reels y publicaciones.": "Novas conversas nos seus reels e publicações.",
    ...
    "Reels, eventos y publicaciones de comunidad nuevos.": "Novos reels, eventos e publicações da comunidade.",
    ...
    "Solo vos y las cuentas que seguís pueden ver tus reels, eventos y listas.": "Somente você e as contas que segue podem ver seus reels, eventos e listas.",
    ...
    "Crear nuevo reel": "Criar novo reel",
    "Géneros": "Gêneros",
    ...
    "Esta cuenta es privada": "Esta conta é privada",
    "Editar perfil": "Editar perfil",
    "Aún no hay publicaciones.": "Ainda não há publicações.",
    "Aún no hay eventos.": "Ainda não há eventos.",
    "Aún no hay favoritos.": "Ainda não há favoritos.",
