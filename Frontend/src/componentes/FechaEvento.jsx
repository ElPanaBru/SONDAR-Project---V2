...
export default function FechaEvento({ fecha: valor }) {
  const diaCalendario = String(valor || "").slice(0, 10);
  ...
  return (
<span className="perfil-evento-calendario" role="img" aria-label={fechaCompleta}>
