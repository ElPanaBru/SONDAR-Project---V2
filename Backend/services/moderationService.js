...
const TIPOS_CONTENIDO_DENUNCIABLE = [
  'reel',
  'evento',
  'perfil',
  'community_post',
    ...
    esquemaModeracionListo = (async () => {
      ...
      await pool.query(`
        CREATE TABLE IF NOT EXISTS content_reports (
          ...
          content_type text NOT NULL CHECK (content_type IN ('reel', 'evento', 'perfil', 'community_post', 'community_comment', 'profile_post', 'profile_post_reply')),
