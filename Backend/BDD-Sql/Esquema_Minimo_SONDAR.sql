...
VALUES
  ...
  ('alternativo', '@alternativo', 'Alternativo', 'alternativo', 'Comunidad de musica alternativa.'),
  ('punk', '@punk', 'Punk', 'punk', 'Comunidad de punk.'),
  ('reggae', '@reggae', 'Reggae', 'reggae', 'Comunidad de reggae.'),
  ('latina', '@latina', 'Latina', 'latina', 'Comunidad de musica latina.');
